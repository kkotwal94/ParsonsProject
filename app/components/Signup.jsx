...
render() {
  return (
	...
	<div className={styles['container']}>
      ...
      <input type="text" className = {styles['form-control']} placeholder="Gender" name = "gender"/>
      <input type="text" className = {styles['form-control']} placeholder="Location" name = "location"/>
